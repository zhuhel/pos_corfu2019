...
\label{sec:detector}
\input{section/detector.tex}

%-------------------------------------------------------------------------------
\section{Data and simulation}
\label{sec:datamc}
\input{section/datamc.tex}

%-------------------------------------------------------------------------------
\section{Event selection}
\label{sec:sel}
\input{section/selection.tex}
...
\label{sec:unc}
\input{section/uncertainty.tex}

%-------------------------------------------------------------------------------
\section{Measurement of fiducial cross-sections}
\label{sec:xs}
\input{section/cross-section.tex}

%-------------------------------------------------------------------------------
\section{Observation of electroweak $ZZjj$}
\label{sec:ewk}
\input{section/electroweak.tex}
